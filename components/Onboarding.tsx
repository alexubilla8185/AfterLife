...
const CreatorGuide = () => (
  <div>
    <h3 className="text-xl font-semibold font-serif text-slate-900 dark:text-slate-100 mb-6 border-l-4 border-primary-500 dark:border-primary-400 pl-4">For Creators: Building Your Legacy</h3>
...
const VisitorGuide = () => (
  <div>
    <h3 className="text-xl font-semibold font-serif text-slate-900 dark:text-slate-100 mb-6 border-l-4 border-primary-500 dark:border-primary-400 pl-4">For Visitors: Connecting with Memories</h3>
      <ul className="space-y-6">
        <FeatureItem
